...
class Destination {
  constructor(location, state, image, imageLink, map, type) {
    ...
    this.map = map;
    this.type = type;
    this.flight = convertString(location);
    this.hotel = convertString(location);
  }
}
...
grandCanyon.hotel = "grand-canyon";
